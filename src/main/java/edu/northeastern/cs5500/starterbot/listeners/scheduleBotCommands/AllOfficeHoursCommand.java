...
public class AllOfficeHoursCommand extends ScheduleBotCommandsWithRepositoryAbstract {
    ...
    public CommandData getCommandData() {
        return new CommandData(
                "allofficehour",
                "Only TA/PROF are allowed to use. List all office Hour of this class");
    }
}
